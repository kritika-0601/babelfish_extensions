...
CREATE OR REPLACE PROCEDURE sys.sp_babelfish_dropextension(IN "@extensionstmt" sys.SYSNAME)
AS 'babelfishpg_tsql', 'sp_babelfish_dropextension' LANGUAGE C;
GRANT EXECUTE on PROCEDURE sys.sp_babelfish_dropextension(IN sys.SYSNAME) TO PUBLIC;
